...
* Click anywhere in the terminal, and type the following command: `ssh cs15lsp23zz@ieng6.ucsd.edu` 
* Replace the "zz" in this line with your own account name you noted down from before, and press enter.
